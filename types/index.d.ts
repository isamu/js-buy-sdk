...
declare namespace ShopifyBuy {
  ...
  export interface Client {
    ...
    shop: ShopResource;
    image: Image;
    customer: ShopifyBuy.CustomerResource;
    graphQLClient: any;
  ...
  export interface CustomerResource {
    ...
    deleteAccessToken(customerAccessToken: string): Promise<any>;
    renewAccessToken(customerAccessToken: string): Promise<any>;
    activate(id: string, input): Promise<any>;
    activateByUrl(activationUrl: string, password: string): Promise<any>;
    createAddress(customerAccessToken: string, address: any): Promise<any>;
    deleteAddress(id: string, customerAccessToken: string): Promise<any>;
    updateAddress(
